...
export async function DELETE(request) {
  ...
  console.log(objFromFrontEnd);
  await Caracteristique_colorModal.deleteOne({ _id:objFromFrontEnd._id  });

  // pour supprimé l'image
  await cloudinary.uploader.destroy(objFromFrontEnd.img.public_id_url);
